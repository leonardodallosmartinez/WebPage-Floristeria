...
$sql1= "UPDATE ".$datomod1." SET  nombre='".$nombre."',documento='".$documento."',direccion='".$direccion."',email='".$email."',telefono='".$telefono."',rut='".$rut."',arl='".$arl."', fk_id_tipoempleado='".$templeo."',salario='".$salario."',fechavinculo='".$fechavinculo."' where id='".$id."'";
