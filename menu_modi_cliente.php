...
<TITLE>Consultar Cliente</TITLE>
	<H1 align="center"><FONT color="#000099"> MODIFICAR-ELIMINAR_Cliente</H1>
<TABLE align="center" border="2" class="tabla">
	<form method="POST" action="modifi_cliente.php" onSubmit="return valida(this);">
	<TR>
		<TD colspan=2>
			<div align=" left"><strong>CONSULTAR CLIENTE </strong></div>
		</TD>
	</tr>
	<TR>
		<TD colspan=2> 
			...
			<br>
				 ...
				 DOCUMENTO CLIENTE: <input type="text" name="documento"  maxlength="10" size="25"onKeyPress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
			<br>
		</TD>
	</tr>
	<tr>
